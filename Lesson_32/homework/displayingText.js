...
const targetTextbox = document.querySelector(".text_target");
const sourceTextbox = document.querySelector(".text_source");

// After pressing Ctrl+E -> hide target textbox -> display source textbox
function editText() {
