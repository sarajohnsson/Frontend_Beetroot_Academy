...
// Parameters works the same as other variables but you don't need to write const or let
function sayHello(userName) {
    // Body of our function
    if (userName) {
        const formattedVal = userName.toUpperCase();
        console.log(`Hello, ${formattedVal}`);
    }
}
...
function getRectanglePerimeter(sideA, sideB = sideA) {
    return sideA * 2 + sideB * 2;
}

console.log(getRectanglePerimeter(50));

// Three or four parameters are more than enough
