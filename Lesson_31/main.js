...
const p = document.querySelector(".testParagraph");

// set/get/remove attribute: get/set/removeAttribute()
...
myNewButton.setAttribute("class", "button");

// Set inner content: innerHTML, textContent

p.append(myNewButton);
// p.prepend(myNewButton);
// p.appendChild();
