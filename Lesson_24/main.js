...
const side = prompt("Provide a square side");
...
const age = +prompt("Add your age"); //String will give you NaN
...
const dayNumber = +prompt("Provide a day number");
...
const properAnswer = 6;

const userAnswer = +prompt("Add your number");
...
let num1 = +promt("Number1");
let num2 = +promt("Number2");
let action = +promt("Action");
