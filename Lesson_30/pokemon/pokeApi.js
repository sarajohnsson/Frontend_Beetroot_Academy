...
const pokemonAttack = document.querySelector('.pokemon_card_bg_stats_attack_name');
const pokemonDamage = document.querySelector('.pokemon_card_bg_stats_attack_dmg');
const pokemonNr = document.querySelector('.pokemon_card_bg_stats_gen_id');
const pokemonWeight = document.querySelector('.pokemon_card_bg_stats_gen_weight');
...
function displayPokemonCard(data) {
    const pokemonSprite = data.sprites.other.dream_world.front_default || data.sprites.front_default;
