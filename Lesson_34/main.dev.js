...
var myEl = $(".my_el"); // const myEl1 = document.querySelector(".my_el");
// console.log(myEl[0]);
// .text vs .textContent
// myEl.text("Hello");
// .html vs .innerHTML
...
myEl.css("color", "blue").slideUp(1000).slideDown(1000); // $.ajax({
//     url: "",
//     method: "GET",
//     success: function () {},
//     error: function () {},
...
document.addEventListener("DOMContentLoaded", function () {// Do something here that will show instantly
});
$(document).ready(function () {// Recommended to write all your code like this
